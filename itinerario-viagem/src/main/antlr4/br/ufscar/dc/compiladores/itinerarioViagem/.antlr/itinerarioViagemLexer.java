...
public class itinerarioViagemLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "VIAGEM", "HOSPEDAGEM", "TRANSPORTE", "ATIVIDADES", "TIPO", "NOME", 
			"CHECK_IN", "CHECK_OUT", "DATA_INICIO", "DATA_FIM", "DESTINO", "COMPANHIA", 
			"DIA", "ATIVIDADE", "LOCAL", "HORARIO", "STRING", "DIA_MES", "ANO", "TEMPO", 
			"DELIM", "TRACO", "ABRECHAVE", "FECHACHAVE", "COMMA", "WS", "COMMENT", 
			"STRING_NAO_FECHADA", "SIMBOLO_NAO_ENCONTRADO"
		};
	}
	...
	public itinerarioViagemLexer(CharStream input) {
		super(input);
